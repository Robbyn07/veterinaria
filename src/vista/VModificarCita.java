    ...
    private void eliminarCita() {
            try {
                ...
                if(res == JOptionPane.YES_OPTION){
                    if(cct.citEliminar(con, cita) == true){
                        JOptionPane.showMessageDialog(null, "Operación Exitosa");
                    }else{
                ...
                Logger.getLogger(VModificarCita.class.getName()).log(Level.SEVERE, null, ex);
            }
    }
}